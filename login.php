...
<body style="background-image: url('./img/b.jpg'); background-size: cover; background-position: center;">

  <div class="container">
    <div class="row min-vh-100 justify-content-center align-items-center">
      <div class="col-lg-5">
      <div class="text-center mb-4">
          <img src="./img/aer.png" alt="Aeroponics Logo" style="max-width: 150px;">
        </div>
        <?php
        if (!empty($login_err)) {
